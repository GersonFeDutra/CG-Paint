...
//             // Mostra cor global (cor para novos objetos)
//             toolBox.showColorEdit((cg::Vector3*)&(toolBox.currentColor.r), "Current Drawing Color");

//             // Se houver item selecionado, mostra também a cor dele para edição
//             if (toolBox.getSelectorTool().hasSelection()) {
//                 CanvasItem* selected = toolBox.getSelectorTool().getSelectedItem();
//                 if (selected) {
//                     Color itemColor = selected->getColor();
//                     if (toolBox.showColorEdit((cg::Vector3*)&itemColor.r, "Selected Item Color")) {
//                         selected->setColor(itemColor);
//                     }
//                 }
//             }
